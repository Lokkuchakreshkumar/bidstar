...
export default function RulesPage() {
  const rules = [
    { num: 1, text: 'Cinebid is a public ranking platform powered by fandom.' },
    ...
    { num: 11, text: 'Cinebid reserves the right to moderate or archive hero listings that violate platform standards.' },
    { num: 12, text: 'Hero profiles and canonical images are curated centrally by Cinebid administrators to ensure visual consistency.' },
  ];
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="rounded-3xl bg-[var(--card-bg)] border border-[var(--card-border)] p-6 sm:p-8 shadow-xs">
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <h1 className="text-xl sm:text-2xl font-black text-[var(--foreground)] tracking-tight">
            Official Cinebid Platform Rules
          </h1>
        </div>
        ...
        <div className="space-y-3 divide-y divide-[var(--card-border)]/50">
          {rules.map((r) => (
            <div key={r.num} className="pt-3 first:pt-0 flex items-start gap-3 text-xs leading-relaxed">
              <span className="font-black text-[#ff5722] shrink-0 mt-0.5">
